    ...
    <div class="flex flex-col md:flex-row gap-8 w-full bg-[#2C3930] p-0 lg:p-8 py-16 md:p-24 justify-around">
      <div class="flex-1 px-4 text-white lg:max-w-lg md:py-12 flex flex-col">
        ...
        <div class="flex flex-row md:flex-col pt-6 md:pt-8 md:pb-4 gap-4 justify-center md:justify-start">
          <HeaderContactCard class="text-white" title="CALL US 24/7" subtitle="Click To Call Us" icon="heroicons-outline:phone"
            url="tel:+19718038020">
          ...
          <HeaderContactCard class="text-white" title="SEND A MESSAGE" subtitle="Click To Email Us" icon="heroicons-outline:mail"
